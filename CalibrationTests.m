...
debug_mode=true;
beta2_range=beta2*[0.7:0.01:1.3];
beta3=0.01;
...
%         Bandwidth_optical=max(Bandwidth_optical)*2;
        ...
        Spectrum_level_1 = interp1(Original_Frequency_axis,Original_Spectrum_level,'spline','extrap');
...
%         a=min(Frequency_axis_3_beta3(end),Frequency_axis_3(end));
        ...
        Spectrum_level_3 = interp1(Frequency_axis_2,Spectrum_level_2,'spline','extrap');
        Spectrum_level_3_ = interp1(Frequency_axis_3,Spectrum_level_3,'spline','extrap');
